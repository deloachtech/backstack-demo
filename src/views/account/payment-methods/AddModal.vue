<template>
  <Modal :open="open" heading="Add Credit Card" :loading="loading" :submitting="submitting" @submit="submit" @cancel="cancel">
...
import { loadStripeJs } from "@/assets/js/stripeUtils.js";
